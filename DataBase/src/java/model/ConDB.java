...
public class ConDB {
    ...
    public static void main (String []args) throws FileNotFoundException, JSONException {
        JsonReader reader = Json.createReader(new FileReader("C:\\Users\\nickk\\Todaycase.txt"));
        ...
        for(int i = 0; i < arr.length(); i++) {
            ...
            Todaycase cov = new Todaycase(yearnum, weeknum, new_case, total_case, new_case_excludeabroad, total_case_excludeabroad,
